package com.backend.adapters.in.web.exception;

import com.backend.adapters.in.web.response.ErrorResponse;
import com.backend.domain.exception.DomainException;
